...
const Chat = () => {
  ...
  // In the return statement, modify the form:
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col contact">
      ...
      <div className="flex flex-col bg-blue-50 w-2/3 p-2 chat-background">
        <div className="flex-grow">
          {!selectedUserId && (
